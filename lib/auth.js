        ...
        await sendEmailGmail({
          ...
          html: `
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                ...
                <p>We received a request to reset your password for your Better Auth account.</p>
                ...
                <p style="color: #666; font-size: 12px;">
                  This is an automated message from Better Auth App. Please do not reply to this email.
                </p>
              </div>
            `,
        });
